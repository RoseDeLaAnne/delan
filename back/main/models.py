...
class Items(models.Model):
    ...
    imageUrl = models.ImageField(upload_to='items', blank=True, null=True)

    item_name = models.CharField(max_length=255, blank=True, null=True)

    item_feedback = models.IntegerField(choices=STATUS, default=-1)
    item_reviews = models.PositiveIntegerField(default=0)
